...
import {
    ...
    ApiOutlined,
    GlobalOutlined,
    DashboardOutlined, CheckOutlined, CopyOutlined, MenuOutlined, LinkedinOutlined, TwitterOutlined
...
export default function Home() {
    ...
    const menuItems = [
        {key: 'donate', label: 'Donate', onClick: () => handleMenuClick('donate')},
        {key: 'api', label: 'API', onClick: () => handleMenuClick('api')},
        {
            ...
            children: isAuthenticated
                ...
                }, {label: 'Logout', key: 'logout', onClick: () => handleMenuClick('logout')}]
                : [{label: 'Login/Signup', key: 'login', onClick: () => handleMenuClick('login')}]
        },
    ];
                    ...
                    <Row justify="space-between" align="middle" style={{height: '100%'}}>
                        ...
                        <Col className="desktop-menu">
                            <Space size={[16, 8]} wrap>
                                <Button type="link" onClick={() => handleMenuClick("donate")}
                                        style={{color: '#4B5563', padding: '4px 8px'}}>Donate</Button>
                                <Button type="link" onClick={() => handleMenuClick("api")}
                                        style={{color: '#4B5563', padding: '4px 8px'}}>API</Button>
                                <Dropdown menu={{items: menuItems.find(item => item.key === 'account')?.children}}>
                        ...
                        <Col className="mobile-menu-toggle">
                            <Button type="text" onClick={toggleMobileMenu} icon={<MenuOutlined/>}/>
                        </Col>
                    </Row>
                    {mobileMenuVisible && (
                        <div className="mobile-menu">
                            ...
                            <Button
                                ...
                                href="https://github.com/quantum-ernest/tialinks"
                                target="_blank"
                                style={{background: '#7C3AED', margin: '16px 0', width: '100%'}}
                            >
                                Star on GitHub
                            </Button>
                        </div>
                        ...
                        <Row align="middle" className="w-full max-w-7xl mx-auto">
                            <Col xs={24} lg={12}>
                                ...
                                <Paragraph style={{fontSize: '18px', marginBottom: '32px', color: '#4B5563'}}>
                                    An open-source, powerful, and easy-to-use URL shortener for developers and
                                    businesses.
                            ...
                            <Row>
                                <Col xs={24} md={8} style={{padding: '10px'}}>
                                    <Card className="tialinks-feature-card">
                                        ...
                                        <Paragraph style={{color: '#6B7280', fontSize: '16px'}}>
                                            Create concise, shareable links instantly. Our advanced algorithm ensures
                                            unique
                                ...
                                <Col xs={24} md={8} style={{padding: '10px'}}>
                                    <Card className="tialinks-feature-card">
                                        ...
                                        <Paragraph style={{color: '#6B7280', fontSize: '16px'}}>Automatically generate
                                            QR
                                ...
                                <Col xs={24} md={8} style={{padding: '10px'}}>
                                    <Card className="tialinks-feature-card">
                                        ...
                                        <Paragraph style={{color: '#6B7280', fontSize: '16px'}}>Integrate TiaLinks into
                                            your
                    ...
                    <div className="join-community-section">
                        <Row justify="center">
                            <Col xs={24} sm={20} md={18} lg={16} xl={14}>
                                <Title
                                    level={2}
                                    className="join-community-title"
                                >
                                    Join the Community
                                </Title>
                            </Col>
                        ...
                        <Row justify="center" gutter={[24, 24]}>
                            <Col xs={24} sm={20} md={18} lg={8} xl={7}>
                                <Space direction="vertical" size="large" className="join-community-content">
                                    <Paragraph>
                                        TiaLinks is open-source and thrives on contributions from passionate developers.
                                    </Paragraph>
                                    <Text type="secondary">
                                        Explore the <a href="https://github.com/quantum-ernest/tialinks"
                    ...
                    <div className="max-w-7xl mx-auto px-4">
                        <Row gutter={[16, 24]} justify="space-between" align="top">
                            <Col xs={24} sm={12} md={8}>
                                <Title level={4} style={{color: '#4B5563', marginBottom: '16px'}}>TiaLinks</Title>
                            ...
                            <Col xs={24} sm={12} md={8}>
                                <Title level={5} style={{color: '#4B5563', marginBottom: '16px'}}>Quick Links</Title>
                                <Space direction="vertical" size="middle">
                                    <Button type="link" style={{color: '#4B5563', padding: '0'}}>Terms of
                                        Service</Button>
                                    <Button type="link" style={{color: '#4B5563', padding: '0'}}>Privacy Policy</Button>
                                </Space>
                            </Col>
                            <Col xs={24} sm={24} md={8}>
                                <Title level={5} style={{color: '#4B5563', marginBottom: '16px'}}>Connect with
                                    Us</Title>
                                <Space size="large" wrap>
                                    ...
                                    <TwitterOutlined style={{fontSize: '24px', color: '#4B5563'}}/>
                                    <LinkedinOutlined style={{fontSize: '24px', color: '#4B5563'}}/>
                                </Space>
                            </Col>
                        </Row>
                        <Divider style={{borderColor: '#E5E7EB'}}/>
